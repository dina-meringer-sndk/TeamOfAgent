...
async function callValidationStrategist(query) {
    try {
...
async function callAgentsFactory(query) {
    try {
...
function activate(context) {
    ...
    context.subscriptions.push(validationStrategistCommand, agentsFactoryCommand, validationStrategistParticipant, agentsFactoryParticipant, analyzeCommand, strategyCommand, createCommand, reviseCommand);
...
async function handleValidationStrategistChat(request, context, stream, token) {
...
async function handleAgentsFactoryChat(request, context, stream, token) {
    const userMessage = request.prompt;
    const command = request.command;
    // Debug logging
...
async function loadAgent(agentId, agentTitle) {
    try {
